...
public abstract class TonbotPlugin {
	...
	/**
	 * Gets a short description of what this plugin does. This resulting sentence
	 * should be grammatically correct when preceded by the words, "This plugin
	 * can..."
	 * 
	 ...
	 * 
	 * @return True if this plugin should be hidden from the help menu. False
	 *         otherwise.
	 */
	...
	/**
	 * Gets the set of Discord4J event listeners. These handlers will be supplied
	 * directly to Discord4J's registerListener method. Typically, one would only
	 * supply a raw event listener if their use case doesn't fit into any of the
	 * existing archetypes such as the routed activity.
	 * 
